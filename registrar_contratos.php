...
<body>
    ...
    <form action="registrar_contratos2.php" method="POST">

        <label for="id_contrato">
            🏷️ Código De Contrato:
            <input type="number" id="id_contrato" name="id_contrato" placeholder=" Ejem. 5" required autofocus>
        </label>
        <br>

        <label for="id_cliente">
            🏷️ Código De Cliente:
            <input type="number" id="id_cliente" name="id_cliente" placeholder=" Ejem. 5" required autofocus>
        </label>
        <br>

        <label for="id_plan">
            🏷️ Código De Proveedor:
            <input type="number" id="id_plan" name="id_plan" placeholder=" Ejem. 5" required autofocus>
        </label>
        <br>
