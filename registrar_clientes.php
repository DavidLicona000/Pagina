...
<body>
    ...
    <div class="marco">
        ...
        <h1>Datos del Inventario para clientes</h1>

        <form action="registrar_clientes2.php" method="POST">
            <label>🏷️ Código del Cliente:
                <input type="number" name="id_cliente" placeholder="Ejem. 98" required autofocus>
            </label>
            ...
            <label>🏷️ DNI:
                <input type="number" name="cedula_identidad" placeholder="Ejem. 0801198701234" required>
            </label>
            ...
            <label>📍 Dirección:
                <input type="text" name="direccion" placeholder="Ejem. Col. Los Robles, Calle 12 #34" required>
            </label>
            ...
            <label>Latitud:
                <input type="number" name="latitud" placeholder="1" required>
            </label>

            <label>Longitud:
                <input type="number" name="longitud" placeholder="-88.025000" required>
            </label>
