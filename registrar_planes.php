...
<body>
    ...
    <div class="marco">
        ...
        <form action="registrar_planes2.php" method="POST">
            ...
            <label for="id_plan">🏷️ Código de Plan:
            ...
            <label for="velocidad_mbps">⚖️ Velocidad en MBPS:
            ...
            <label for="incluye_telefonia">✅ Incluye Telefonia?:
            ...
            <label for="descripcion">📝 Descripcion:
                <input type="text" id="descripcion" name="descripcion" placeholder="Ejem. Plan con 50 Mbps, 120 canales y telefonía fija." required>
            </label>

            <label for="precio_mensual">💵 Precio Mensual:
