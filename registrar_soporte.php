...
<body>
    ...
    <div class="marco">
        ...
        <form action="registrar_soporte2.php" method="POST">

            <label for="id_ticket">🏷️ Código de Ticket:
                <input type="number" id="id_ticket" name="id_ticket" placeholder="Ejem. 8" required autofocus>
            </label>

            <label for="id_cliente">🏷️ Código de Cliente:
                <input type="number" id="id_cliente" name="id_cliente" placeholder="Ejem. 1" required autofocus>
            </label>

            <label for="id_tecnico">🏷️ Código de Tenico:
                <input type="number" id="id_tecnico" name="id_tecnico" placeholder="Ejem. 1" required autofocus>
            </label>

            <label for="fecha_creacion">📅 Fecha de Creacion:
            ...
            <label for="prioridad"> Elija la prioridad que desee:
            ...
            <label for="descripcion">🏷️ Descripcion:
                <input type="text" id="descripcion" name="descripcion" placeholder="Ejem. Cliente sin conexión desde anoche." required autofocus>
            </label>

            <label for="estado"> Estado de Soporte:
