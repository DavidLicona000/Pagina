...
<body>
    ...
    <form action="registrar_pagos2.php" method="POST">

        <label for="id_pago">
            🏷️ Código De Pago:
            <input type="number" id="id_pago" name="id_pago" placeholder=" Ejem. 05" required autofocus>
        </label>
        <br>

        <label for="id_factura">
            🏷️ Codigo De Factura:
            <input type="number" id="id_factura" name="id_factura" placeholder=" Ejem. 07" required autofocus>
        </label>
        <br>

        <label for="fecha_pago">📅 Fecha de Pago:
        ...
        <br>
         ...
         <label for="monto">
            🏷️ Monto:
            <input type="number" id="monto" name="monto" placeholder=" Ejem. 504.00" required autofocus>
        </label>
        <br>

        <label for="metodo_pago">
            Metodo de Pago que desea:
        ...
        <label for="referencia">
            Metodo de Referencia que desea:
            <select id="referencia" name="referencia" required>
                <option value="">Seleccione un metodo de referencia</option>
                <option value="REC-1001">REC-1001</option>
                <option value="POS-2025-0045">POS-2025-0045</option>
            </select>
        </label>
        <br>
