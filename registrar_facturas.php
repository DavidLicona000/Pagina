...
<div class="marco">
    ...
    <form action="registrar_facturas2.php" method="POST">
        <label for="id_factura">🏷️ Código de Factura:
            <input type="number" id="id_factura" name="id_factura" placeholder="Ejem. 98" required>
        </label>

        <label for="id_contrato">🏷️ Código de Contrato:
            <input type="number" id="id_contrato" name="id_contrato" placeholder="Ejem. 10" required>
        </label>
        ...
        <label for="subtotal">🏷️ Subtotal:
            <input type="number" id="subtotal" name="subtotal" placeholder="Ejem. 1100.00" step="0.01" required>
        </label>

        <label for="impuestos">🏷️ Impuestos (15%):
            <input type="number" id="impuestos" name="impuestos" readonly>
        </label>

        <label for="total">🏷️ Total:
            <input type="number" id="total" name="total" readonly>
        </label>

        <label for="estado">Estado del Plan:
...
subtotalInput.addEventListener('input', () => {
    ...
    let impuestos = subtotal * 0.15; // 15% de ejemplo
